...
Bayer Credit Analyst Agent for preventive, forward-looking credit decision support in Bill-to-Cash. Covers T1 credit block analysis, T2 TRM utilization, T3 DCD decision support, T4 payment term validation, and T5 seasonal financing eligibility. Read-only, guardrail-bound, with three-tier escalation model.
